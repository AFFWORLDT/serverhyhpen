...
app.get('/api-docs', swaggerUi.setup(swaggerSpec, {
  ...
  customSiteTitle: 'Hyphen Gym API Documentation',
...
app.use('/api/clients', checkMongoConnection, require('./routes/clients'));
...
app.use('/api/performance', checkMongoConnection, require('./routes/performance'));
app.use('/api/budget', checkMongoConnection, require('./routes/budget'));
app.use('/api/invoices', checkMongoConnection, require('./routes/invoices'));
